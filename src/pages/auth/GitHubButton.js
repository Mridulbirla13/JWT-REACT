        ...
        <div className="github-button">
            ...
            <button className="gsi-material-button" style={buttonStyle} onClick={handleGitHubLogin}>
                ...
                <div className="gsi-material-button-content-wrapper">
                    <div className="gsi-material-button-icon" style={{ height: '30px' }}>
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 19" width="18" height="25" style={{ display: 'block' }}>
